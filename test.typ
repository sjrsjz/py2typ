  ...
  gutter: 5pt,
    ...
    {figure(caption: figure.caption(position: top)[条形图])[#context{
      cetz.canvas({
        ...
        cetz.draw.rect((-0.06032789723279114, 0.0), (0.06032789723279114, 0.0), fill: rgb(0, 127, 0), stroke: black)
        cetz.draw.rect((0.10724959508051758, 0.0), (0.22790538954609985, 3.1566137566137566), fill: rgb(0, 127, 0), stroke: black)
        cetz.draw.rect((0.27482708739382633, 0.0), (0.3954828818594086, 2.078270227790439), fill: rgb(0, 127, 0), stroke: black)
        cetz.draw.rect((0.44240457970713504, 0.0), (0.5630603741727174, 1.0262279786378266), fill: rgb(0, 127, 0), stroke: black)
        cetz.draw.rect((0.6099820720204437, 0.0), (0.730637866486026, 0.4504360726131381), fill: rgb(0, 127, 0), stroke: black)
        cetz.draw.rect((0.7775595643337524, 0.0), (0.8982153587993347, 0.18535049569997214), fill: rgb(0, 127, 0), stroke: black)
        cetz.draw.rect((0.9451370566470612, 0.0), (1.0657928511126435, 0.07321930016538018), fill: rgb(0, 127, 0), stroke: black)
        cetz.draw.rect((1.11271454896037, 0.0), (1.2333703434259524, 0.028120493551086267), fill: rgb(0, 127, 0), stroke: black)
        cetz.draw.rect((1.2802920412736787, 0.0), (1.4009478357392608, 0.010579507760817179), fill: rgb(0, 127, 0), stroke: black)
        cetz.draw.rect((1.4478695335869873, 0.0), (1.5685253280525697, 0.003918037240485376), fill: rgb(0, 127, 0), stroke: black)
      })}]
    }}],
    cell[#{
    {figure(caption: figure.caption(position: top)[饼图])[#context{
      cetz.canvas({
        ...
        cetz.draw.rect((-0.8958692739069484, -0.8958692739069484), (0.8958692739069484, 0.8958692739069484), stroke: black)
        {
          let x-max-text-width = 0
        }
           cetz.draw.arc((0.7166954191255587, 0.0), radius: 0.7166954191255587, start: 0.0deg, stop: 54.00000214576721deg, fill: rgb(31, 119, 180), mode:"PIE")
           cetz.draw.arc((0.42126297603295537, 0.5798187896398477), radius: 0.7166954191255587, start: 54.00000214576721deg, stop: 162.00000643730164deg, fill: rgb(255, 127, 14), mode:"PIE")
           cetz.draw.arc((-0.6816178734409856, 0.22147098771926954), radius: 0.7166954191255587, start: 162.00000643730164deg, stop: 324.0000021457672deg, fill: rgb(44, 160, 44), mode:"PIE")
           cetz.draw.arc((0.5798187896398476, -0.42126297603295537), radius: 0.7166954191255587, start: 324.0000021457672deg, stop: 360.000002682209deg, fill: rgb(214, 39, 40), mode:"PIE")
      })}]
    }}],
    cell[#{
    {figure(caption: figure.caption(position: top)[散点图])[#context{
      cetz.canvas({
        ...
        cetz.draw.circle((0.6426362421778675, 2.976962027439872), radius: 1.0pt, fill: rgb(31, 119, 180), stroke: none)
        cetz.draw.circle((1.6312363843324194, 2.3799273578506335), radius: 1.0pt, fill: rgb(31, 119, 180), stroke: none)
        cetz.draw.circle((1.255955803907757, 2.884588507044373), radius: 1.0pt, fill: rgb(31, 119, 180), stroke: none)
        cetz.draw.circle((1.0271787167052933, 2.7474311855371134), radius: 1.0pt, fill: rgb(31, 119, 180), stroke: none)
        cetz.draw.circle((0.2676969108467866, 1.8357608837419797), radius: 1.0pt, fill: rgb(31, 119, 180), stroke: none)
        cetz.draw.circle((0.26765552554878763, 2.830474528114538), radius: 1.0pt, fill: rgb(31, 119, 180), stroke: none)
        cetz.draw.circle((0.09965990925287285, 0.271702758870141), radius: 1.0pt, fill: rgb(31, 119, 180), stroke: none)
        cetz.draw.circle((1.486185739188492, 0.6017355501973175), radius: 1.0pt, fill: rgb(31, 119, 180), stroke: none)
        cetz.draw.circle((1.0313936286777057, 0.13886350694435562), radius: 1.0pt, fill: rgb(31, 119, 180), stroke: none)
        cetz.draw.circle((1.2149115079698243, 0.99887726488571), radius: 1.0pt, fill: rgb(31, 119, 180), stroke: none)
        cetz.draw.circle((0.03531889214457483, 1.1933744607745622), radius: 1.0pt, fill: rgb(31, 119, 180), stroke: none)
        cetz.draw.circle((1.6641721174299358, 0.8331359023666556), radius: 1.0pt, fill: rgb(31, 119, 180), stroke: none)
        cetz.draw.circle((1.4283057637695054, 2.5445123868645747), radius: 1.0pt, fill: rgb(31, 119, 180), stroke: none)
        cetz.draw.circle((0.36433161973040423, 1.0953567912666606), radius: 1.0pt, fill: rgb(31, 119, 180), stroke: none)
        cetz.draw.circle((0.3119754274113003, 0.8625666533771152), radius: 1.0pt, fill: rgb(31, 119, 180), stroke: none)
        cetz.draw.circle((0.31468560797546286, 1.6662657242486363), radius: 1.0pt, fill: rgb(31, 119, 180), stroke: none)
        cetz.draw.circle((0.5220190892473198, 0.43268638392453385), radius: 1.0pt, fill: rgb(31, 119, 180), stroke: none)
        cetz.draw.circle((0.9003775144852766, 2.463023733923706), radius: 1.0pt, fill: rgb(31, 119, 180), stroke: none)
        cetz.draw.circle((0.7411316161854017, 0.22889640470843944), radius: 1.0pt, fill: rgb(31, 119, 180), stroke: none)
        cetz.draw.circle((0.4996911968883969, 3.030086133285529), radius: 1.0pt, fill: rgb(31, 119, 180), stroke: none)
        cetz.draw.circle((1.0498176970736794, 2.3710600274115103), radius: 1.0pt, fill: rgb(31, 119, 180), stroke: none)
        cetz.draw.circle((0.23934368017019847, 0.6101262553511881), radius: 1.0pt, fill: rgb(31, 119, 180), stroke: none)
        cetz.draw.circle((0.5012620268419304, 0.016954820154215254), radius: 1.0pt, fill: rgb(31, 119, 180), stroke: none)
        cetz.draw.circle((0.6286039502955445, 2.5037502017218487), radius: 1.0pt, fill: rgb(31, 119, 180), stroke: none)
        cetz.draw.circle((0.7825252518457122, 2.170297889626137), radius: 1.0pt, fill: rgb(31, 119, 180), stroke: none)
        cetz.draw.circle((1.3472055565925494, 2.238305553578235), radius: 1.0pt, fill: rgb(31, 119, 180), stroke: none)
        cetz.draw.circle((0.3426004386995565, 2.368068211093779), radius: 1.0pt, fill: rgb(31, 119, 180), stroke: none)
        cetz.draw.circle((0.8823238699169771, 0.22734283345189626), radius: 1.0pt, fill: rgb(31, 119, 180), stroke: none)
        cetz.draw.circle((1.0164654016678925, 1.1006144605192718), radius: 1.0pt, fill: rgb(31, 119, 180), stroke: none)
        cetz.draw.circle((0.07969965612723989, 0.3557583118420083), radius: 1.0pt, fill: rgb(31, 119, 180), stroke: none)
        cetz.draw.circle((1.0424259536788438, 2.650027703624889), radius: 1.0pt, fill: rgb(31, 119, 180), stroke: none)
        cetz.draw.circle((0.2925854308593692, 1.9137420315935696), radius: 1.0pt, fill: rgb(31, 119, 180), stroke: none)
        cetz.draw.circle((0.11161557643650152, 1.0159720221764836), radius: 1.0pt, fill: rgb(31, 119, 180), stroke: none)
        cetz.draw.circle((1.628098580718179, 0.19514624088508134), radius: 1.0pt, fill: rgb(31, 119, 180), stroke: none)
        cetz.draw.circle((1.6568322319417639, 0.9548238868917189), radius: 1.0pt, fill: rgb(31, 119, 180), stroke: none)
        cetz.draw.circle((1.3870488309206512, 0.9984258969351651), radius: 1.0pt, fill: rgb(31, 119, 180), stroke: none)
        cetz.draw.circle((0.5226565542288095, 2.2401447235252196), radius: 1.0pt, fill: rgb(31, 119, 180), stroke: none)
        cetz.draw.circle((0.1675858930781476, 1.9575231786739253), radius: 1.0pt, fill: rgb(31, 119, 180), stroke: none)
        cetz.draw.circle((1.1740075863834476, 2.724051691083395), radius: 1.0pt, fill: rgb(31, 119, 180), stroke: none)
        cetz.draw.circle((0.7552140086688783, 1.4498640559499898), radius: 1.0pt, fill: rgb(31, 119, 180), stroke: none)
        cetz.draw.circle((0.20939330313671958, 0.36719592974516757), radius: 1.0pt, fill: rgb(31, 119, 180), stroke: none)
        cetz.draw.circle((0.849624947272575, 2.1899095623325855), radius: 1.0pt, fill: rgb(31, 119, 180), stroke: none)
        cetz.draw.circle((0.0590038526488117, 2.3358746992495245), radius: 1.0pt, fill: rgb(31, 119, 180), stroke: none)
        cetz.draw.circle((1.560212689433473, 1.7233162079772546), radius: 1.0pt, fill: rgb(31, 119, 180), stroke: none)
        cetz.draw.circle((0.4440149040323926, 2.3671373837874548), radius: 1.0pt, fill: rgb(31, 119, 180), stroke: none)
        cetz.draw.circle((1.136756277235687, 1.5161242222693074), radius: 1.0pt, fill: rgb(31, 119, 180), stroke: none)
        cetz.draw.circle((0.5348341192387834, 1.6049715919632737), radius: 1.0pt, fill: rgb(31, 119, 180), stroke: none)
        cetz.draw.circle((0.8923331359938812, 1.3126996245400864), radius: 1.0pt, fill: rgb(31, 119, 180), stroke: none)
        cetz.draw.circle((0.9380459443394326, 0.07804555984176333), radius: 1.0pt, fill: rgb(31, 119, 180), stroke: none)
        cetz.draw.circle((0.31717342594525366, 0.33126420535966034), radius: 1.0pt, fill: rgb(31, 119, 180), stroke: none)
      })}]
    }}],
  )
}